...
# New mode (not working since Cinnamon 5.4.9)
#RATE_NEW=-r
...
# ROTATE_ACTIVE=$(gsettings get org.cinnamon.settings-daemon.peripherals.touchscreen orientation-lock) #(not working since Cinnamon 5.4.9)
ROTATE_LOCK=true
